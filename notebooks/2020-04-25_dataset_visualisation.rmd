...
```
```{r}
smol_train <- filter(train$tag != 'O')  # train$tag
```

```{r}
barplot(table(train$polarity, train$target))
...
```{r}
train_conll <- system.file(package = 'udpipe', '/home/fero/Desktop/nlp/in5550_exam/data/raw/train.conll')
