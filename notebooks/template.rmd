...
install.packages(c('reticulate', 'rms', 'car', 'rlang', 'stringi', 'multcomp', 'ggplot2'))
install.packages(c('tidyverse', 'tidytext', 'topicmodels', 'SnowballC', 'tm'))
install.packages(c('dplyr', 'corrgram', 'caTools', 'SnowballC', 'tm'))
