...
from models.improved import Improved
...
def improved(parsed_args: Namespace, paths: PathTracker, logger: Logger):
    # Parse and store command line arguments.
    args = parsed_args
    ...
    s = f'Train data shapes: X={X_train.shape}, y={y_train.shape}'
    print(s);
    logger.info(s)  # X=(5915, 30) y=(5915, 30, 6)
    s = f'Dev data shapes: X={X_dev.shape}, y={y_dev.shape}'
    print(s), logger.info(s)  # X=(1151, 30) y=(1151, 30, 6)
    ...
    plot_results(bilstm.results, path_to.figures, 'improved', 'accuracy')
    plot_results(bilstm.results, path_to.figures, 'improved', 'binary_accuracy')
    plot_results(bilstm.results, path_to.figures, 'improved', 'loss')
    plot_results(bilstm.results, path_to.figures, 'improved', 'precision')
    plot_results(bilstm.results, path_to.figures, 'improved', 'recall')
