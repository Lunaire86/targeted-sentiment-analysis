...
% My own additions, including support for using BibLaTeX over BibTeX
...
% You can expand the titlebox if you need extra space to show all the authors.
...
\begin{abstract}
  Enim dui pharetra ad duis sociis himenaeos feugiat mi ipsum cum vehicula
  taciti iaculis curabitur id natoque et pharetra scelerisque id scelerisque
  enim vel adipiscing. Vivamus parturient lorem suspendisse in rhoncus conubia
  aenean adipiscing dis vehicula ornare nisl eu netus parturient at. In
  parturient blandit aliquam adipiscing nulla nam ut euismod dignissim
  vestibulum ullamcorper curae nascetur a facilisi dis. Sem primis consectetur
  orci per interdum rutrum eget varius suspendisse sem habitasse semper nec a.
  Cum congue aliquam at a volutpat phasellus ante suspendisse adipiscing vivamus
  a parturient aenean in platea lobortis imperdiet libero sodales euismod.
\end{abstract}

\section{Credits}
\label{sec:credits}

Lorem ipsum dolor sit amet consectetur adipiscing elit tellus, dis per neque
nisl pharetra aenean.
...
Subsection~\ref{subsec:first}). \textbf{Type single-spaced.}  Start all
...
\label{subsec:electronically-available-resources}
...
and example bibliography (\texttt{\small references.bib}).
...
where \verb|acl2019| corresponds to a references.bib file.
